...
function CategoryHero({ eyebrow, title, subtitle }: { eyebrow: string; title: string; subtitle: string }) {
  return (
    <section className="category-hero bg-gradient-to-br from-cream via-[#FFF3E0] to-lavender-ultra pt-40 pb-20 relative overflow-hidden text-center">
      ...
      <div className="category-hero-decoration absolute top-0 right-0 w-64 h-64 bg-amber-500/5 blur-3xl rounded-full -translate-y-1/2 translate-x-1/2" aria-hidden="true" />
    </section>
  )
}

function CestasChocolatesPage() {
  const cestasChocolates = products.filter(p => p.category === 'cestas-chocolates');
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-12 products-catalog-grid reveal-stagger">
            ...
            <article className="product-card bg-[#F0EAFF] border-2 border-dashed border-[#C4A8DC] rounded-2xl p-8 flex flex-col items-center justify-center text-center h-full group">
              ...
              <div className="product-card-body">
                ...
                <a 
                  href="https://wa.me/5511918475136?text=Olá! Quero saber mais sobre as cestas personalizadas de café e chocolates!" 
      ...
      <section className="py-24 bg-cream-warm plants-cta-section">
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto bg-white p-12 rounded-3xl shadow-xl border border-gold-main/10 text-center plants-cta-box reveal-scale">
            ...
            <h2 className="font-serif text-3xl font-bold text-text-dark mb-6 plants-cta-title">Quer montar uma cesta do seu jeito?</h2>
            <p className="text-text-medium mb-10 leading-relaxed plants-cta-text">
              Escolha os cafés, chocolates e itens especiais que mais combinam com quem você quer presentear. Fale com a gente e montamos a cesta perfeita para o seu momento.
            </p>
            <a 
