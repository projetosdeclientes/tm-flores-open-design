        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
            <div className="flex flex-col gap-6">
              <div 
                className="relative w-full rounded-xl overflow-hidden group/gallery bg-white flex items-center justify-center md:bg-transparent md:block"
                ...
                {mainImage ? (
                  <>
                    <img 
                      src={mainImage} 
                      alt={product.name} 
                      className="w-full h-full object-contain object-center bg-white block transition-all duration-500 md:h-auto md:bg-transparent             md:max-h-[580px]"
                      loading="eager"
                      decoding="async"
                      width="600"
                      height="520"
              ...
              <div className="hidden md:flex gap-4">
                {product.images.map((img, i) => (
                    <button 
                      ...
                      className={`relative w-24 aspect-square md:max-h-20 rounded-xl overflow-hidden transition-all duration-300 bg-white md:bg-transparent ${
                    ...
                    >
                      <div className="w-full h-full overflow-hidden flex items-center justify-center">
                        <img 
                          ...
                          className="w-full h-full object-contain bg-white block md:h-auto md:bg-transparent"
                          loading="lazy"
                          decoding="async"
                          width="96"
                          height="96"
